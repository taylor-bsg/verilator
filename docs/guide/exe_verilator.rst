...
.. option:: --lib-create <name>
   ...
   Wrapper ports and DPI arguments are ordered independently of the internal
   C++ field layout. Source-declared ports retain their declaration order.
   Additional enable and output ports generated by :vlopt:`--pins-inout-enables`
   precede the source-declared ports, sorted by name. Positional instantiations
   must follow the generated wrapper's port list; named connections avoid
